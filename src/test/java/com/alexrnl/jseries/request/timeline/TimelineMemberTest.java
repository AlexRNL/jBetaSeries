...
public class TimelineMemberTest {
	...
	public void testNullTypes () {
		...
		assertEquals(new HashSet<>(Arrays.asList(new Version(), new Id(1), new NumberEventsPerPage(28), new SinceId(48))), request.getParameters());
	}
	...
	public void testGetParameters () {
		assertEquals(new HashSet<>(Arrays.asList(new Version(), new Id(8), new NumberEventsPerPage(25))), timelineMember.getParameters());
		assertEquals(new HashSet<>(Arrays.asList(new Version(), new Id(4), new NumberEventsPerPage(50), new SinceId(128), new Types("movies", "show"))), timelineMemberPerType.getParameters());
	}
}
