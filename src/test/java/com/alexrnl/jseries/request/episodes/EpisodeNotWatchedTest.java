...
public class EpisodeNotWatchedTest {
	...
	public void testGetParameters () {
		assertEquals(new HashSet<>(Arrays.asList(new Version(), new Id(8))), episodeNotWatched.getParameters());
		assertEquals(new HashSet<>(Arrays.asList(new Version(), new TheTVDBId(88))), episodeNotWatchedTVDB.getParameters());
	}
